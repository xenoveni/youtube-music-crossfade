# YouTube Music Crossfade

**🎧 New: Standalone Desktop App Available!**
We have migrated from a Chrome extension to a full-featured Windows desktop application.
Check the [`app/`](app/) directory for the new Electron-based player.

## Desktop App Features
- **Dual Players**: 50-50 split view
- **Seamless Crossfade**: Configurable fade in/out
- **Ad Free**: Built-in ad blocking
- **Persistent Login**: Login once with Google
- **No Sidebar**: Clean, full-screen UI

---

## Original Chrome Extension (Legacy)
This repository also contains the original Chrome extension source code. Google Chrome Extension
